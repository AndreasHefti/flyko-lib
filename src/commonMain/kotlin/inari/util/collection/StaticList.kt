 ...
 *
 * If the index to set is higher than the current capacity of the internal ArrayList the internal ArrayList is
...
class StaticList<T>(
     ...
     * NOTE: this is not the same as length of an array which also counts the null/empty values
     */
    var size = 0
        private set
     ...
     * If there is no empty position the list is growing by the growth value and the value is added
    ...
    /** Use this to get the index of a specified object in the StaticList. This internally uses
     ...
     * Remove sets a null value on specified index of internal ArrayList instead of removing it
