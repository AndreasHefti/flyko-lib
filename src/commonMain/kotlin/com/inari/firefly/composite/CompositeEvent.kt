...
typealias CompositeEventListener = (
    ...
    compId: CompId,
    compositeType: KClass<out Composite>) -> Unit
...
class CompositeEvent(override val eventType: EventType) : Event<CompositeEventListener>() {
    ...
    var compId: CompId = NO_COMP_ID
        private set
    var compositeType: KClass<out Composite> = Composite.typeClass
    ...
    companion object : EventType("PlayerEvent") {
        ...
        fun send(type: CompositeEventType, compId: CompId, compositeType: KClass<out Composite> = Composite.typeClass) {
