...
class EasedPositionAnimation private constructor() : TypedAnimation<PositionF>() {

    @JvmField var startValue = PositionF()
    @JvmField var endValue = PositionF()
    @JvmField var easing: Easing.EasingFunctions.EasingFunction = Easing.Type.LINEAR

    override fun update(timeStep: Float, data: AnimatedObjectData<PositionF>) {
