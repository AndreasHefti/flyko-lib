...
import com.inari.firefly.core.ComponentNode
...
class TiledTileSet private constructor() : TileSet() {
    ...
    override fun load() {
        ...
        val textAssetName = "$TILE_SET_ASSET_NAME_PREFIX${this@TiledTileSet.name}"
        ...
        // create tile set
        textureRef(this@TiledTileSet.textureAssetId)
