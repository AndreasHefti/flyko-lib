...
class CollisionSensorMatrix(
    ...
    private val contactSensorPointTopLeft = Position()
    private val contactSensorPointTopMiddle = Position()
    private val contactSensorPointTopRight = Position()
    private val contactSensorPointCenterLeft = Position()
    private val contactSensorPointCenterRight = Position()
    private val contactSensorPointBottomLeft = Position()
    private val contactSensorPointBottomMiddle = Position()
    private val contactSensorPointBottomRight = Position()
